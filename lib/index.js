...
var ReactDatatable = function (_Component) {
  ...
  _createClass(ReactDatatable, [{
    ...
    value: function onChange() {
      ...
      // if (this.state.fetchFilters.hasOwnProperty(Object.keys(this.state.filter)[0])) {
      // delete this.state.fetchFilters[Object.keys(this.state.filter)[0]];
      // tableData = Object.assign(tableData, this.state.fetchFilters);
      // } else {
      tableData = Object.assign(tableData, this.state.fetchFilters, this.state.filter);
      this.state.fetchFilters = Object.assign(this.state.fetchFilters, this.state.filter);
      // }
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'as-react-table', id: this.props.id ? this.props.id + "-container" : "" }, _react2.default.createElement(_TableHeader2.default, {
        config: this.config,
      ...
      }), _react2.default.createElement('div', { className: 'row table-body asrt-table-body', style: _style2.default.table_body, id: this.props.id ? this.props.id + "-table-body" : "" }, _react2.default.createElement('div', { className: 'column' }, _react2.default.createElement('table', { className: this.props.className, id: this.props.id }, _react2.default.createElement('thead', { className: this.props.tHeadClassName ? this.props.tHeadClassName : '' }, _react2.default.createElement('tr', null, this.props.columns.map(function (column, index) {
      ...
      }))), _react2.default.createElement('tbody', null, this.props.loading === true ? _react2.default.createElement('tr', null, _react2.default.createElement('td', { colSpan: this.props.columns.length, className: 'asrt-td-loading', align: 'center' }, _react2.default.createElement('div', { className: 'asrt-loading-textwrap' }, _react2.default.createElement('span', { className: 'asrt-loading-text' }, this.config.language.loading_text)))) : filterRecords.length ? filterRecords.map(function (record, rowIndex) {
        rowIndex = _lodash2.default.indexOf(_this8.props.records, record);
        return _react2.default.createElement('tr', { key: record[_this8.config.key_column], onClick: function onClick(e) {
            return _this8.props.onRowClicked(e, record, rowIndex);
          } }, _this8.props.columns.map(function (column, colIndex) {
          if (column.cell && typeof column.cell === "function") {
            return _react2.default.createElement('td', { className: column.className, key: column.key ? column.key : column.text }, column.cell(record, rowIndex));
          } else if (record[column.key]) {
            return _react2.default.createElement('td', { className: column.className, key: column.key ? column.key : column.text }, record[column.key]);
          } else {
            return _react2.default.createElement('td', { className: column.className, key: column.key ? column.key : column.text });
          }
        }));
      }) : _react2.default.createElement('tr', null, _react2.default.createElement('td', { colSpan: this.props.columns.length, align: 'center' }, this.config.language.no_data_text)))))), _react2.default.createElement(_TableFooter2.default, {
        config: this.config,
        id: this.props.id,
        isFirst: isFirst,
        isLast: isLast,
    ...
    value: function addFilterDropdown(e) {
      ...
      if (value !== "All") {
        Object.defineProperty(filter, key, { value: value, enumerable: true });
      } else {
        delete this.state.fetchFilters[Object.keys(this.state.filter)[0]];
      }
      this.setState({
    ...
    key: 'addFilterSwitch',
    value: function addFilterSwitch(e) {

      var _this9 = this;
      var name = e.target.name;
      var value = void 0;
      var filter = new Object();
      var trueElmt = document.getElementById(name + "-true");
      var falseElmt = document.getElementById(name + "-false");

      if (e.target.id === trueElmt.id) {
        trueElmt.classList.contains("is-success") ? trueElmt.classList.remove("is-success") : trueElmt.classList.add("is-success");
        falseElmt.classList.remove("is-danger");
      } else if (e.target.id === falseElmt.id) {
        falseElmt.classList.contains("is-danger") ? falseElmt.classList.remove("is-danger") : falseElmt.classList.add("is-danger");
        trueElmt.classList.remove("is-success");
      }

      if (trueElmt.classList.contains("is-success")) {
        value = true;
        Object.defineProperty(filter, name, { value: value, enumerable: true });
      } else if (falseElmt.classList.contains("is-danger")) {
        value = false;
        Object.defineProperty(filter, name, { value: value, enumerable: true });
      } else {
        Object.defineProperty(filter, name, { value: value, enumerable: true });
