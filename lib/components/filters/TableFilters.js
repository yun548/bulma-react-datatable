...
function TableFilters(_ref) {
    ...
    return _react2.default.createElement('div', {
        ...
        return filter.type === "dropdown" ? _react2.default.createElement(_dropdownFilter2.default, {
            props: props,
            filter: filter,
            key: filter.key
        }) : filter.type === "switch" ? _react2.default.createElement(_switchFilter2.default, {
            props: props,
            filter: filter,
            key: filter.key
        }) : null;
