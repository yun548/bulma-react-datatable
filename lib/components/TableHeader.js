...
var _tableFilters = require ("./filters/TableFilters");
...
function TableHeader(props) {
  ...
  if (props.config.show_length_menu == true || props.config.show_filter == true || props.config.button.excel == true || props.config.button.csv == true || props.config.button.print == true) {
    ...
    _react2.default.createElement(
      'div',
      { className: 'level notification mb-0', id: props.id ? props.id + "-table-head" : "" },
      _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          ...
          props.config.show_length_menu ? _react2.default.createElement(
            ...
            (0, _includes2.default)(props.config.language.length_menu, '_MENU_') ? _react2.default.createElement(
              'select',
              { type: 'text', className: 'input', style: _style2.default.table_size_dropdown,
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          props.config.show_filter ? _react2.default.createElement(
            'div',
            { className: 'table_filter control', style: _style2.default.table_filter },
          ...
          _react2.default.createElement(
            ...
            props.config.button.excel ? _react2.default.createElement(
              'button',
              { className: 'button is-primary buttons-excel',
                tabIndex: '0',
              ...
              _react2.default.createElement(
                'span',
                null,
                _react2.default.createElement('i', { className: 'iconify', 'data-icon': 'fa:file-excel-o' })
              )
            ) : null,
            props.config.button.csv ? _react2.default.createElement(
              'button',
              { className: 'button is-primary buttons-csv',
                tabIndex: '0',
                'aria-controls': 'configuration_tbl',
                title: 'Export to CSV',
                style: _style2.default.table_tool_btn,
              ...
              _react2.default.createElement(
                'span',
                null,
                _react2.default.createElement('i', { className: 'iconify', 'data-icon': 'fa:file-text-o' })
              )
            ) : null,
            props.config.button.print ? _react2.default.createElement(
              'button',
              { className: 'button is-primary buttons-pdf',
                tabIndex: '0',
                'aria-controls': 'configuration_tbl',
                title: 'Export to PDF',
                style: _style2.default.table_tool_btn,
              ...
              _react2.default.createElement(
                'span',
                null,
                _react2.default.createElement('i', { className: 'iconify', 'data-icon': 'fa:print' })
              )
            ) : null,
            props.config.button.extra == true ? props.extraButtons.map(function (elem, index) {
              ...
              return _react2.default.createElement(
                'button',
                { className: elem.className ? elem.className : "button is-primary buttons-pdf",
                  tabIndex: '0',
                  'aria-controls': 'configuration_tbl',
    ...
    props.filters ? _react2.default.createElement(
      _tableFilters2.default,
      {props:props},
      ) : null
    )
  } else {
